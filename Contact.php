    ...
    <div class="container">
        <div class="main-title">
				  <h2 class="title">Call Us or Fill The Form</h2>
                        <p class="subtitle">Leave your information and submit to us. Subscribe to our newsletters for more updates and reports.</p><br>
                    
        </div>

        <div class="row">
            <div class="col-lg-12 col-md-7 col-md-12">
