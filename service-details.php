    ...
    <div class="breadcrumb-area breadcrumb-area-bg bg-img section-space--inner--bottom--50 section-space--inner--top--120" data-bg="assets/img/backgrounds/20.jpg">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <h2 class="breadcrumb-page-title breadcrumb-page-title--style2">Service Details</h2>
                </div>
                <div class="col-lg-12">
        ...
        <div class="container">
			...
			<?php
		           	$id=$_GET['id'];
				   							...
				   							$result = mysqli_query($conn, "SELECT * FROM `tbl_service` where id='$id'");
                ...
                <div class="col-lg-8 order-1 order-lg-2">
                    <div class="service-details-page-content">
                        <div class="service-details-image-block section-space--bottom--50">
								...
								<div class="image">
									<img src="./admin/gallery/<?php echo $image; ?>" alt=" " class="img-fluid" />
								</div><br>
            ...
            <div class="container-fluid--cp-60">
                <div class="row align-items-center">
                    <div class="col-md-4 col-sm-6 col-9">
                        ...
                        <div class="logo">
                            <a href="index.html">
                                <img src="assets/img/logo1/logo-dark.png" class="img-fluid" alt="">
                            </a>
                        </div>
                    </div>
...
<!-- Mirrored from demo.hasthemes.com/megan-preview/megan/service-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jul 2019 09:08:01 GMT -->
</html>