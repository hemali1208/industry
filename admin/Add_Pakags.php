   ...
   <link rel="stylesheet" type="text/css" href="css/jquery.datetimepicker.css"/>
    ...
    if (in_array($imgExt, $valid_extensions)) {
       ...
       $query=mysqli_query($conn,"insert into `tbl_pakags`(tital,price,nodays,descrip,image)values('$tital','$price','$nodays','$descrip','$userpic')");
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">      
                        <h3 class="panel-title"><b> Add Pakags </b> </h3>  
                ...
                <div class="box">
                    ...
                    <form name="form_register" id='form_register' method="post" class="my_frm"  enctype="multipart/form-data" >
                        ...
                        <table class="table">
							...
							<tr>
                                <th width="30%"> <span class="error">*</span>Pakag Name :</th>

                                <td><input type="text" name="tital" id="UserName" class="form-control" placeholder="Pakag Name" maxlength="100"/></td>
                            </tr>
							
							
							<tr>
                                <th width="30%"> <span class="error">*</span>Pakag Price :</th>

                                <td><input type="text" name="price" id="phone" class="form-control" placeholder="Pakag Price" maxlength="100"/></td>
                            </tr>
							<tr>
                                <th width="30%"> <span class="error">*</span>Number Days :</th>

                                <td><input type="text" name="nodays" id="phone" class="form-control" placeholder="Pakag Price" maxlength="100"/></td>
                            </tr>

							<tr>
                                <th>Pakag Description :</th>
