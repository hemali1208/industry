   ...
   <link rel="stylesheet" type="text/css" href="css/jquery.datetimepicker.css"/>
    ...
    if (in_array($imgExt, $valid_extensions)) {
	   ...
	   //die;
        //echo  $q="insert into `tbl_service`(s_name,s_description,image,isstatus,create_by)values('$s_name','$s_description','$userpic',1,now())";
       $query=mysqli_query($conn,"insert into `tbl_service`(name,description,image,isstatus,create_by)values('$name','$description','$userpic',1,now())");
		//$qry=mysqli_query($conn,"insert into tbl_service(`s_name`,`s_description`,`image`,`isstatus`,`create_by`)values('$s_name')");
