...
// $query=mysqli_query($conn,"insert into `tbl_image`(image)values('$userpic')");
		$qry=mysqli_query($conn,"update tbl_service set `name`='$name',`description`='$description',`image`='$userpic' where `id`='$demo'");
                    ...
                    <form name="form_register" id='form_register' method="post" class="my_frm"  enctype="multipart/form-data" >
						...
						<input type="hidden" class="form-control" id="" value="<?php echo $row['id']; ?>" name="reupdate">
							...
							<tr>
							   ...
							   <tr><th width="30%"> <span class="error">*</span>Service Description :</th>
