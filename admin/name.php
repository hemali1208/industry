...
$(document).ready(function() {
  $("#basic").validate({
    ...
    if (in_array($imgExt, $valid_extensions)) {
	  ...
	  $query=mysqli_query($conn,"insert into `tbl_name`(name,image,is_status,create_by)values('$name','$userpic',1,now())");
                    ...
                    <form name="basic" id="basic" method="post" class="my_frm"  enctype="multipart/form-data" >
                        ...
                        <table class="table">
							...
							<tr>
                                ...
                                <td><input type="text" name="name" id="name" class="form-control" placeholder=" name" maxlength="100"/></td>
                            </tr>
