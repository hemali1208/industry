<link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-alpha/css/bootstrap.css" rel="stylesheet">
   ...
   <link rel="stylesheet" type="text/css" href="css/jquery.datetimepicker.css"/>
	...
	$result=mysqli_query($conn,"select * from tbl_category where c_id='$update'");
	...
	else
	{
		...
		$qry=mysqli_query($conn,"update tbl_category set `c_name`='$c_name',`image`='$userpic' where `c_id`='$demo'");
            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <form name="form_register" id='form_register' method="post" class="my_frm"  enctype="multipart/form-data" >
						...
						<tr>
						<input type="hidden" class="form-control" id="reupdate" value="<?php echo $row['c_id'];?>" name="reupdate">
  						</tr>	
							...
							<tr>
                                <th width="30%"> <span class="error">*</span>client_name:</th>

                                <td><input type="text" name="c_name" id="c_name" value="<?php echo $row['c_name'];?>" class="form-control"  maxlength="100"/></td>
                            </tr>
