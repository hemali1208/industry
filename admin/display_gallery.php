    ...
    <div class="panel-body">
        <table id="customers2" class="table datatable">
            ...
            <tbody>
				...
				{
					?>
					<a href="action_gallery.php?id=<?php echo $row['id'];?>"onclick="return confirm('active')">Deactive</a>
					<?php
				}
				?>
				...
				{
					?>
					<a href="action_gallery.php?id=<?php echo $row['id'];?>"onclick="return confirm('deactive')">Active</a>
					<?php
				}
				?></td>
			...
			<td class="text-center" width="300"><a href="edit_gallery.php?id=<?php echo $row['id'];?>">Edit|<a href="delete_gallery.php?id=<?php echo $row['id'];?>"onclick="return confirm('are you sure want to delete')">Delete</td>
